...
# --- STATION DATABASE ---
# Kept intact to match your setup exactly
STATIONS = [
...
# --- 🎯 BRAND NEW MANUAL OVERRIDE MATRIX ---
...
# Grab selected coordinates instantly
user_lat, user_lon = preset_options[selected_zone]
st.success(f"📍 **Active Proximity Anchor:** Calibrated to **{selected_zone}**")
