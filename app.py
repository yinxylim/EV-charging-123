...
def get_master_database():
    return [
        ...
        {"state": "Selangor", "town": "Subang Jaya / PJ", "building": "Subang Jaya / PJ Landmark Area", "operator": "Tesla Supercharger Hub", "type": "DC", "kw": 250, "rate": 0.75, "dist": 1.9},
