...
# Comprehensive Malaysian EV Market Database (Updated)
EV_MODELS = {
...
max_dc_limit = st.sidebar.number_input("Max Vehicle DC Fast-Charge Limit (kW)", min_value=20.0, max_value=450.0, value=default_specs["max_dc_kw"], step=5.0)
